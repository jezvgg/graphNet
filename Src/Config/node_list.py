    ...
    "Data & Preprocessing": {
        ...
        "Processing Utils": [
            NodeAnnotation(
                ...
                annotations={"num_classes": Parameter(AttrType.INPUT, AInteger)},
    ...
    "Neural Network Layers": {
        ...
        "Convolutional": [
            ...
            NodeAnnotation(
                ...
                annotations={
                    "pool_size": Parameter(
                        AttrType.INPUT, ASequence[AInteger, AInteger], default=(2, 2)
                    ),
                    "strides": Parameter(AttrType.INPUT, AInteger, default=1),
                    "padding": Parameter(AttrType.INPUT, AEnum[Padding]),
                },
        ...
        "Utils": [
            NodeAnnotation(
                ...
                annotations={
                    ...
                    "filepath": Parameter(
                        AttrType.INPUT, AString, default="model.keras"
                    ),
                },
                input=False,
                output=False,
            ...
            NodeAnnotation(
                ...
                annotations={
                    ...
                    "data": Parameter(
                        AttrType.STATIC, AFloat, backfield=MetricNode.data
                    ),
                },
                input=False,
                output=DataNode,
            ...
            NodeAnnotation(
                ...
                annotations={
                    "model": Parameter(AttrType.INPUT, ANode[Single[CompileNode]]),
                    "filename": Parameter(
                        AttrType.INPUT, AString, default="model.json"
                    ),
                },
                input=False,
                output=False,
