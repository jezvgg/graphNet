...
class AttributesFactory:
    ...
    @build_attribute.register((int, float, str, bool, File))
    ...
    build_input.register(int)(lambda value, parent, *a, **k: dpg.add_input_int(**AttributesFactory.check_kwargs(dpg.add_input_int, k)))
    build_input.register(str)(lambda value, parent, *a, **k: dpg.add_input_text(**AttributesFactory.check_kwargs(dpg.add_input_text, k)))
    build_input.register(float)(lambda value, parent, *a, **k: dpg.add_input_float(**AttributesFactory.check_kwargs(dpg.add_input_float, k)))
    build_input.register(bool)(lambda value, parent, *a, **k: dpg.add_checkbox(**AttributesFactory.check_kwargs(dpg.add_checkbox, k)))
